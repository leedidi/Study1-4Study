...
-- 강의 진행 여부(강의 예정, 강의 중, 강의 종료
/*
교수자명 - 교수테이블, 배정된 과목명 - 과목, 과목기간 - 과목개설, 교재명 - 교재테이블
강의실 - 과정, 강의진행여부 - 과목기간으로 만들기
*/

-- 교수자 정보 출력 VIEW
SELECT P.PRO_NAME, S.SUB_NAME, SL.SUB_STARTDATE, SL.SUB_ENDDATE
